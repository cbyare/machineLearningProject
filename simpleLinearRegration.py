...
# Paractise: plot  Emission against Cylinder
...
# Finally use the predictions and the test_y data and find the Mean Absolute Error value using the np.absolute and 
# np.mean function like done previously
